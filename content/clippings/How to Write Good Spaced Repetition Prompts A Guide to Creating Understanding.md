...
description: A guide on writing effective spaced repetition prompts for understanding, using retrieval practice and iterative refinement.
...
## Key takeaways
- **Focus on Retrieval Practice:** Design prompts that require active recall of information, not just passive recognition.
- **Break Down Knowledge:** Deconstruct complex information into smaller, focused prompts targeting individual details.
- **Be Precise and Consistent:** Write clear, unambiguous questions that elicit the same answer each time.
- **Ensure Tractability:** Create prompts that are challenging but achievable, avoiding frustration and inconsistent recall.
- **Embrace Effortful Retrieval:** Don't make prompts too easy; some effort is needed for effective learning.
- **Use Cues and Elaborative Encoding:**  Add helpful cues or mnemonic devices, particularly for arbitrary information.
- **Interpret and Connect:** Go beyond the text; write prompts that connect ideas and explore implications.
- **Handle Lists Strategically:** Use cloze deletions or other techniques to break down lists into manageable parts.
- **Address Conceptual Knowledge:** Use various lenses (attributes, similarities, parts/wholes, causes/effects, significance) to explore concepts.
- **Use Open Lists and Salience Prompts:**  Keep ideas top-of-mind and encourage application in real-life contexts.
- **Iterate and Revise:** Write prompts incrementally, revise over time, and delete prompts that are no longer relevant or engaging.

## Analogies And Concrete Examples
- **Retrieval Practice as Translation:**  Like translating a text, prompt-writing involves finding the right \\"words\\" (tasks) to activate the same \\"bulbs\\" (ideas) in your mind.
- **Chicken Stock Recipe:**  The guide uses this recipe to illustrate how different types of knowledge (factual, procedural, conceptual) can be translated into prompts. For example, remembering ingredient ratios is factual, while understanding *why* low heat is used is conceptual.
- **Open Lists as Tags:**  Think of open lists (like ways to use chicken stock) as tags in a filing system, connecting instances to a broader category.
- **Salience Prompts as Baader-Meinhof Control:**  These prompts keep ideas top-of-mind, increasing the likelihood of noticing relevant connections in daily life, similar to how you suddenly notice a new word everywhere after learning it.
- **Prompt-Writing as Sentence-Writing:**  Both skills require iterative refinement and attention to detail, and both can be developed to a high level of proficiency.
- **Litmus Tests as Spell/Grammar Checkers:**  Simple tests help identify potential prompt issues, like a spell checker helps avoid errors in writing.
 
## Examples
**Example 1: History**

Q. What event marked the beginning of World War I?
A. The assassination of Archduke Franz Ferdinand of Austria.

**Example 2: Science (Biology)**
...
Q. Who is the author of the novel \\"One Hundred Years of Solitude\\"?
...
A. In a right-angled triangle, the square of the hypotenuse (the side opposite the right angle) is equal to the sum of the squares of the other two sides (a² + b² = c²).

**Example 6: Foreign Language (Spanish)**
...
Q. In object-oriented programming, what is the term for creating a new object from a class?
A. Instantiation.

**Example 8: Music**

Q. What are the four main families of instruments in an orchestra?
A. Strings, woodwinds, brass, and percussion.

**Example 9: Art**

Q. Which artist is known for painting \\"Starry Night\\"?
A. Vincent van Gogh

**Example 10: Culinary Arts**

Q. What are the five French mother sauces?
A. Béchamel, Velouté, Espagnole, Sauce Tomat, and Hollandaise.
...
> 
> ![](https://andymatuschak.org/prompts/aromats-cloze.jpg)
> 
> A. Carrots
> 
> ![](https://andymatuschak.org/prompts/aromats.jpg)
...
As you build fluency in increasingly complex concepts, you can write increasingly complex prompts while keeping each focused on what feels like a single detail. In fact, the ability to think in terms of increasingly complex “chunks” appears to be a significant part of what expertise actually is.For a compelling demonstration, see Chase and Simon, [Perception in chess](https://andymatuschak.org/prompts/Chase1973.pdf) (1973), which experimentally demonstrates how chess masters operate in terms of larger chunks. Viewed through this lens, one role for memory systems is to accelerate the process of increasing your effective chunk size in a topic.
