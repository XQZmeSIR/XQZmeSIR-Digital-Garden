...
**Write down ideas for next steps**: At the end of a work session, write down what you think the next steps could be for the next one. Works like [[2.4b Записка — простой способ сосредоточиться]] that saves you from deciding what to do, that can be unproductive.
