...
These are [[How to Write Good Spaced Repetition Prompts A Guide to Creating Understanding|memory prompts]] that I wrote while studying the topic.  cd

**Q**: Расскажи об Big O notation\
**A**: `О большое` _показывает лишь динамику изменения вычислительной сложности алгоритма(**то бишь зависимость этой динамики от размера входных данных `n`**)_.
