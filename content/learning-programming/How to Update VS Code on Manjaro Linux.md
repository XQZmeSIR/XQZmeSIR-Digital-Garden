...
publish: true
created: 2024-10-02
modified: 2026-03-13T18:53:40.780+03:00
---
...
1. **Download the Latest VS Code Archive:**
   - Head over to the official VS Code website (<https://code.visualstudio.com/Download>) and download the `.tar.gz` archive for Linux 64-bit.
   - _Explanation:_ This downloads the compressed source code for VS Code.
...
3. **Create a Symbolic Link for Easy Access(BUT USUALLY NOT NEEDED):**
   ...
   ```
   - _Explanation:_ This creates a symbolic link (shortcut) named `vscode` in `/usr/local/bin`, which is in your system's PATH. This allows you to launch VS Code simply by typing `vscode` in your terminal, regardless of your current directory.
