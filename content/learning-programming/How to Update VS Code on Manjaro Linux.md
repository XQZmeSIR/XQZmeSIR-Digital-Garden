...
### Related:
- [[learning-programming/How to switch the cursor between terminal and code in VSCode?]]
- [[learning-programming/How to install DBeaver database tool OR any other using tar.gz package and bash commands]]
